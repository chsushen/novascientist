    ...
    def compile_pdf(self) -> CompilationResult:
        ...
        if rendered and summary_pdf_path.exists():
            return CompilationResult(
                ...
                log_messages="Direct IEEE-style publication draft PDF generated successfully.",
            )
        ...
        try:
            ...
            with PdfPages(str(output_pdf)) as pdf:
                ...
                fig1.text(
                    0.5,
                    0.96,
                    "IEEE TRANSACTIONS-STYLE RESEARCH DRAFT — GENERATED BY NOVASCIENTIST v2.3.0",
                    ha="center",
                    fontsize=7.5,
                    color="#475569",
                    style="italic",
                ...
                fig1.text(
                    0.5,
                    0.875,
                    f"{author} • IEEE-Style Publication Draft — Requires Human Scientific Verification",
                    ha="center",
                    fontsize=8.0,
                    color="#1E293B",
                )
                ...
                fig1.text(
                    0.5,
                    0.03,
                    f"Page 1 of {total_pages} — IEEE Transactions-Style Research Draft (NovaScientist v2.3.0)",
                    ha="center",
                    fontsize=7.5,
                    color="#64748B",
                )
                ...
                eth_box.text(
                    0.0,
                    0.82,
                    "Generated research artifact for research automation and infrastructure demonstration. Scientific claims, empirical results, and manuscript content require independent human verification before submission or publication. In compliance with IEEE and ACM 2024+ authorship policies, algorithmic tooling and compilation pipelines (NovaScientist v2.3.0) operated under human researcher supervision.",
                    fontsize=6.8,
                    color="#334155",
                    wrap=True,
                    va="top",
                ...
                fig7.text(
                    0.5,
                    0.03,
                    f"Page 7 of {total_pages} — IEEE Transactions-Style Research Draft (Requires Human Verification)",
                    ha="center",
                    fontsize=7.5,
                    color="#64748B",
                )
                ...
                if total_pages >= 10:
                    for p_num in range(8, 11):
                        ...
                        fig_ext.text(
                            0.5,
                            0.03,
                            f"Page {p_num} of {total_pages} — IEEE Transactions-Style Extended Research Draft",
                            ha="center",
                            fontsize=7.5,
                            color="#64748B",
                        )
